...
//	  	  items.add(lasagna);
//	      items.add(Ravioli);
//	 	  items.add(sideDishes);
//		  items.add(moltencake);
//		  items.add(iceCream);
//		  items.add(specialityTiramisu);
//		  items.add(specialityCrostata);
//		  items.add(pancakes);
//		  items.add(fruitSalad);
//		  items.add(specialityHotChocolate);
//		  items.add(specialityCoffee);
//		  items.add(specialityTea);
//		  items.add(water);
